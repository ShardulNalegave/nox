    ...
    <div className='p-[30px]'>
      ...
      <div className="flex">
        <div className="grow">
          ...
          <h1 className='font-mono font-bold text-muted-foreground'>Categories</h1>
        </div>
        <Dialog>
          ...
          <DialogContent className='select-none'>
            <DialogHeader>
              ...
              <DialogDescription>Creates a new People category.</DialogDescription>
            </DialogHeader>
            ...
            <Dialog>
              ...
              <DialogContent className='select-none'>
                <DialogHeader>
                  ...
                  <DialogDescription>Deleting would mean loss of all people data of this category.</DialogDescription>
                </DialogHeader>
                <Button className='mt-[10px]' variant='destructive' type="submit">Confirm</Button>
              </DialogContent>
            </Dialog>
          </div>
        </div>
